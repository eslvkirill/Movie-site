...
public class MovieRestController {
    ...
    public ResponseEntity<ReviewDtoResponse> addReview(@PathVariable Long id,
                                                       @Valid @RequestBody CreateReviewDtoRequest reviewDto) {
        return ResponseEntity.status(HttpStatus.CREATED).body(movieService.addReview(id, reviewDto));
    }
